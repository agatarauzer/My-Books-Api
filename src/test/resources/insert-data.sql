INSERT INTO users (user_id, first_name, last_name, email, username, password,  enabled, registration_date) VALUES
	(1, 'Adam', 'Monday', 'user1@test.com', 'adamon', '$2a$10$1XCd1hHx4wXf71/2k1SaZu2FdNWDtNJcVm097KAD9zDfBbg2fJB1C', 
	 true, '2022-01-23'),
	(2, 'Barbara', 'Tuesday', 'user2@test.com', 'bartue', '$3g$54$rrrenVoK9h7OadrUtd7wU.dMGf6amRFjiP7X5OKjuhqAAeGyWzRVe', 
	 true, '2022-02-02'),
	(3, 'Connel', 'Wednesday', 'user3@test.com', 'conwed', '$2a$10$R5uEvRzi78IXR8Dif4Klze3fM7N4YizTcdN0NuPfAMsAGyRxCSzr6', 
	 true, '2022-03-11'),
	(4, 'David', 'Thursday', 'user4@test.com', 'davthu', '$2a$10$7WXJw.k.xVBdEME4su3bluOoQk0GKqilvZ64caErD9kC.OmMBFyGq', 
	 true, '2022-04-18'),
	(5, 'Anthony', 'Smith', 'admin@test.com', 'admin', '$2a$10$hN7slczAV5QRI6NTEIHyIuqUcWvs9d9se4X2w5e1pr61tpcL3YfrS', 
	 true, '2022-01-10');
...
INSERT INTO readings (reading_id, status, start_date, end_date, readed_pages, rate, notes) VALUES
	...
	(7, 'READED', '2022-02-28', '2022-11-09', 180, 5, null),
